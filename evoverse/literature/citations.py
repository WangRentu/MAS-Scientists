...
from evoverse.literature.base_client import PaperMetadata, Author, PaperSource
...
class CitationNetwork:
    ...
    def __init__(self, use_knowledge_graph: bool = False):
        ...
        if use_knowledge_graph:
            try:
                from evoverse.knowledge.graph import get_knowledge_graph
...
def papers_to_bibtex(papers: List[PaperMetadata], output_file: str):
    ...
    Example:
        ```python
        from evoverse.literature.citations import papers_to_bibtex
...
def papers_to_ris(papers: List[PaperMetadata], output_file: str):
    ...
    Example:
        ```python
        from evoverse.literature.citations import papers_to_ris
