...
def get_cache(
    ...
    config = get_config()
    if cache_dir == ".literature_cache":
        cache_dir = config.literature.cache_dir
    if ttl_hours == 48:
        ttl_hours = config.literature.cache_ttl_hours
    if max_cache_size_mb == 1000:
        max_cache_size_mb = config.literature.max_cache_size_mb
